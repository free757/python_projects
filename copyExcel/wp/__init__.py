...
print('done')
print('loading>.........wb_2')
wb_2=openpyxl.load_workbook('C:/Users/free\PycharmProjects\copyExcel/wp/files/Firewall vs (Autosaved).xlsx')
print('done')
...
wb_2.save('C:/Users/free\PycharmProjects\copyExcel/wp/files/Firewall vs (Autosaved).xlsx')
